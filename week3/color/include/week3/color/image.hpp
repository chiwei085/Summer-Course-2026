...
// Produces a single-channel image (still stored as `Rgb8` with r == g == b)
// by resizing with nearest-neighbor sampling. Used to keep large source
// photos responsive in the browser.
